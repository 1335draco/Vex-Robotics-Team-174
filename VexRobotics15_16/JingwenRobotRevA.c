...
#pragma config(Motor,  port4,           leftForklift,  tmotorVex393_MC29, openLoop)
...
void liftMotors (int leftFspeed, int rightFspeed)
{
		motor[leftForklift] = leftFspeed;
		motor[rightForklift] = rightFspeed;
}
void teleop ()
{
	liftMotors (vexRT[
